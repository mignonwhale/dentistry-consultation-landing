...
export default function Home() {
  ...
  return <main className="jd-page">
    ...
    <header className="jd-header"><div className="jd-container jd-header-inner"><a className="jd-logo" href="#top"><Image src="/images/logo-mark.svg" alt="" aria-hidden="true" width={36} height={36} className="jd-logo-mark" />정도치과</a><nav><a href="#doctor">의료진</a><a href="#faq">자주 묻는 질문</a><a href="#location">오시는 길</a></nav><a className="jd-header-cta" href="tel:02-521-7981">전화 상담</a></div></header>
    ...
    <div className="jd-paper jd-signature"><ArchDivider /></div>
    <footer className="jd-footer"><div className="jd-container jd-footer-grid"><div className="jd-footer-brand"><a className="jd-logo" href="#top"><Image src="/images/logo-mark.svg" alt="" aria-hidden="true" width={36} height={36} className="jd-logo-mark" />정도치과</a><p>치료를 권하기 전에<br />정확히 설명하는 치과</p></div><div className="jd-footer-column"><b>정도치과</b><a href="#doctor">의료진 소개</a><a href="#faq">자주 묻는 질문</a><a href="#location">오시는 길</a></div><div className="jd-footer-column"><b>진료 안내</b><span>임플란트 · 보철 · 보존</span><span>평일 09:30-18:30</span><span>토요일 09:30-14:00</span><span>일요일 휴진</span></div><div className="jd-footer-contact"><b>상담 문의</b><a href="tel:02-521-7981">02-521-7981</a><span>서울시 강남구 테헤란로 419, 8층</span></div></div><div className="jd-container jd-legal"><span>© 2026 정도치과. All rights reserved.</span><span><a href="/privacy">개인정보처리방침</a> · <a href="/terms">이용약관</a></span></div></footer>
